...
fuse_box_1.Sparky.src(tasks_1.p('./script/manifest.json'), { base: './' }).dest(tasks_1.p('dev/')).exec();
fuse_box_1.Sparky.src(tasks_1.p('./script/icon192x192.png'), { base: './' }).dest(tasks_1.p('dev/')).exec();
fuse_box_1.Sparky.src(tasks_1.p('./script/favicon.ico'), { base: './' }).dest(tasks_1.p('dev/')).exec();
